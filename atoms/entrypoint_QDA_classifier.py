...
def get_args():
    ...
    parser.add_argument(
        ...
        default=0,
        metavar='reg_param',
        help='Regularizes the covariance estimate as identity matrix')
    parser.add_argument(
        '--model-dir',
...
def main():
    ...
    t = Trainer(train_data_path=args.train_files, model_path=args.model_dir, algo=QuadraticDiscriminantAnalysis,
